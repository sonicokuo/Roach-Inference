...
class KeyboardControl(object):
    ...
    def parse_events(self, client, world, clock, sync_mode, map):
    ...
    def __init__(self, parent_actor, hud, gamma_correction):
        ...
        if not self._parent.type_id.startswith("walker.pedestrian"):
            self._camera_transforms = [
                ...
                (carla.Transform(carla.Location(x=11.2, y=0,z=19.2), carla.Rotation(pitch=-90.0)), Attachment.Rigid)]
        ...
        for item in self.sensors:
            ...
            if item[0].startswith('sensor.camera'):
                ...
                bp.set_attribute('image_size_x', str(192*10))# str(hud.dim[0]))
                bp.set_attribute('image_size_y', str(192*10)) #str(hud.dim[1]))
...
def game_loop(args):
    ...
    try:
        ...
        while True:
            ...
            if controller.parse_events(client, world, clock, args.sync, args.map ):
                return
            world.tick(clock)
